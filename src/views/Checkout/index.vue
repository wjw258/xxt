...
defaultAddress.value=curAddress.value.find((item)=>item.isDefault===0)
...
const confirm=()=>{
  defaultAddress.value=address.value
...
<template>
  ...
  <div class="addressWrapper">
    <div class="text item" :class="{active:address.id===item.id}" @click="changeaddress(item)" v-for="item in checkInfo.userAddresses"  :key="item.id">
      <ul>
